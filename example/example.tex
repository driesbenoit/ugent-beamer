...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \item Instead, this theme makes use of \textsc{Small Caps} for all titles and subtitles.
        \item If one insists on strictly following the UGent styleguide, it is always possible to type the titles in ALL-CAPS surrounded by an underline:
            \begin{itemize}
                \itemsep.25cm
                \item E.g., \verb|\frametitle{\underline{MY UGENT TITLE}}|
                \item For the main title, the following syntax would be necessary to avoid a pdfstring warning:\\
                    \verb|\title{\texorpdfstring{\underline{MY TITLE}}{MY TITLE}}|
            \end{itemize}
